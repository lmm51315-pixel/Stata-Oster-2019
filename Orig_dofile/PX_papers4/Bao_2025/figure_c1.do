* Figure C1: Dynamic Effects of AI Training on Number of Errors
...
eststo: reghdfe error interaction1-interaction4 interaction6-interaction10, absorb(month id class teacher) vce(cluster id)
...
eststo: reghdfe error interaction1-interaction4 interaction6-interaction10 if gender == 0, absorb(month id class teacher) vce(cluster id)
...
eststo: reghdfe error interaction1-interaction4 interaction6-interaction10 if gender == 1, absorb(month id class teacher) vce(cluster id)
...
graph export "`path_results'/figure_c1.eps" , as(eps) replace
graph export "`path_results'/figure_c1.png" , as(png) replace
graph export "`path_results'/figure_c1.pdf" , as(pdf) replace
