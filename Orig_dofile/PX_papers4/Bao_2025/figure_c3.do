* Figure C3: Dynamic Eﬀects of AI Training on Error Magnitude.
...
eststo: reghdfe error_magnitude interaction1-interaction4 interaction6-interaction10, absorb(month id class teacher) vce(cluster id)
...
eststo: reghdfe error_magnitude interaction1-interaction4 interaction6-interaction10 if gender == 0, absorb(month id class teacher) vce(cluster id)
...
eststo: reghdfe error_magnitude interaction1-interaction4 interaction6-interaction10 if gender == 1, absorb(month id class teacher) vce(cluster id)
...
graph export "`path_results'/figure_c3.eps" , as(eps) replace
graph export "`path_results'/figure_c3.png" , as(png) replace
graph export "`path_results'/figure_c3.pdf" , as(pdf) replace
